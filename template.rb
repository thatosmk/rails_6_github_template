...
def apply_template!
  ...
  add_tailwindcss_and_stimulus_turbolinks

  unless any_local_git_commits?
    git checkout: "-b main"
    git add: "-A ."
    git commit: "-n -m 'Set up project from template'"
...
def add_tailwindcss_and_stimulus_turbolinks
  run_with_clean_bundler_env "yarn add tailwindcss stimulus turbolinks"
end
